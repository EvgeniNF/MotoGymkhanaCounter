                    ...
                    configs::laser_sensor::filterTime)
{
    ...
    //  this->m_networkData.m_espStatus = reinterpret_cast<unsigned short
    //  int*>(&this->state);
    this->m_state = STATE::NOT_INIT;
}

Logic::~Logic() { delete this->m_networkData.m_timeOnEsp; }
...
void Logic::initDisplay(int csDisplayPin, unsigned short int updatePeriod)
{
...
//    state = State::COUNT;
//  } else if (*this->timer_register_ptr > 3'000 && this->state ==
//  State::COUNT){
//    // Stop timer
...
//    this->prev_time = this->prev_time - (act_time *
//    this->time_convers[index]); if (index == 0)
